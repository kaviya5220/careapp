...
import UIKit
    ...
    class DescriptionTableViewHeader: UITableViewHeaderFooterView {
        ...
        override init(reuseIdentifier: String?) {
            ...
            //
            addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(DescriptionTableViewHeader.tapHeader(_:))))
        }
        ...
        @objc func tapHeader(_ gestureRecognizer: UITapGestureRecognizer) {
            guard let cell = gestureRecognizer.view as? DescriptionTableViewHeader else {
                return
            }
